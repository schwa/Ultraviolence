...
struct FunctionConstantsTests {
    ...
    func applyToMTLConstants() throws {
        ...
        FunctionConstants.Value.int16(32767).apply(to: mtlConstants, at: 3)
        FunctionConstants.Value.uint16(65535).apply(to: mtlConstants, at: 4)
        FunctionConstants.Value.int32(2147483647).apply(to: mtlConstants, at: 5)
        FunctionConstants.Value.uint32(4294967295).apply(to: mtlConstants, at: 6)
        FunctionConstants.Value.int64(9223372036854775807).apply(to: mtlConstants, at: 7)
        FunctionConstants.Value.uint64(18446744073709551615).apply(to: mtlConstants, at: 8)
