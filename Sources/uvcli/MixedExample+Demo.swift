...
extension MixedExample: Demo {
    static func main() throws {
        ...
        let element = MixedExample(drawableSize: .init(size), colorTexture: offscreenRenderer.colorTexture, depthTexture: offscreenRenderer.depthTexture, modelMatrix: .identity)
